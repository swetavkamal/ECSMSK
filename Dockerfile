FROM ubuntu:18.04
ENV PROFILE="arn:aws:iam::155945893157:role/ecsInstanceRole"
...
RUN aws --version
RUN sh TLS_STEPS_AUTOMATION.sh Example-Alias arn:aws:acm-pca:us-east-1:155945893157:certificate-authority/2f974c2c-bce1-4b3c-8853-db6bfe362dd3 changeit changeit
EXPOSE 8080
